...
test('test searchObjDate function', (t) => {
  const testCases = [
    ...
    {
      input: { a: new Date('2020-02-02 8:0:12'), b: [new Date('2020-02-02 8:0:12'), { c: { d: new Date('2020-02-02 8:0:12'), e: [new Date('2020-02-02 8:0:12')] } }] },
      expect: { a: '2020-02-02 08:00:12.00', b: ['2020-02-02 08:00:12.00', { c: { d: '2020-02-02 08:00:12.00', e: ['2020-02-02 08:00:12.00'] } }] }
    }
  ];
